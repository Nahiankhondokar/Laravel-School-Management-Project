      ...
      <section class="content">
        <div class="row">
          <div class="col-12">
            ...
            <form action="{{ route('student.mark.update') }}" method="POST">
              @csrf

                <div class="box bb-3 border-warning">
                <div class="box-header">
                    <h4 class="box-title"><strong>Student Mark Edit</strong></h4>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="controls pt-4">
                                <a href="#" class="btn btn-round btn-primary" id="markEditSearch">Search</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            ...
                            <input type="submit" class="btn btn-rounded btn-info f-right" value="Mark Update">
